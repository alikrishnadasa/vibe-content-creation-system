...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Whisper Transcriber CLI")
    parser.add_argument('--all-scripts', type=str, default=None, help='Directory containing .wav files to batch transcribe')
    ...
    if args.all_scripts:
        ...
        transcriber.transcribe_all_scripts(args.all_scripts, force_retranscribe=args.force)
    else:
