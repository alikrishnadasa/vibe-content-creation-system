...
def create_mjanime_metadata(clips_directory: Path, 
                          output_file: Path,
    ...
    metadata = {
        "metadata_info": {
            ...
            "generator": "create_mjanime_metadata.py",
            "version": "1.0.0"
        },
...
Examples:
  ...
  python create_mjanime_metadata.py /path/to/MJAnime/fixed
  
  # Force recreate existing metadata
  python create_mjanime_metadata.py /path/to/MJAnime/fixed --force
  
  # Custom output location
  python create_mjanime_metadata.py /path/to/MJAnime/fixed --output custom_metadata.json
        """
    )
    ...
    parser.add_argument("--output", "-o",
                       help="Output metadata file (default: ./mjanime_metadata.json)")
    ...
    if args.output:
        ...
        output_file = Path("./mjanime_metadata.json")
