...
def load_mjclip_metadata(metadata_path: str = "./MJAnime/mjclip_metadata.json") -> Dict[str, Any]:
...
def main():
    ...
    # Load metadata
    try:
        metadata = load_mjclip_metadata()
        print(f"✅ Loaded metadata from: ./MJAnime/mjclip_metadata.json")
        ...
        print("Run: python3 create_mjclip_metadata.py ./MJAnime/fixed --output ./MJAnime/mjclip_metadata.json")
